...
public class WebserviceUtils {
     ...
     */
    public static SoapSerializationEnvelope getEnvelope(SoapObject request, int envolopeVesion, String
            soapAction, String
                                                                resultUrl) throws IOException,
     ...
     * @throws XmlPullParserException
     */
    private static SoapSerializationEnvelope getEnvelope(SoapObject request, int envolopeVesion, String
            serviceName, int
     ...
     * @throws XmlPullParserException
     */
    public static SoapObject getSoapObjResponse(SoapObject request, int envolopeVesion, String serviceName,
                                                int timeout) throws
     ...
     * @throws XmlPullParserException
     */
    public static SoapPrimitive getSoapPrimitiveResponse(SoapObject request, int envolopeVesion, String
            serviceName) throws
            IOException, XmlPullParserException {
     ...
     * @throws XmlPullParserException
     */
    public static SoapPrimitive getSoapPrimitiveResponseByTime(SoapObject request, int envolopeVesion,
                                                               String serviceName, int
                                                                       timeout) throws
            IOException, XmlPullParserException {
        SoapSerializationEnvelope envelope = getEnvelope(request, envolopeVesion, serviceName, timeout *
                1000);
        SoapPrimitive sob = (SoapPrimitive) envelope.getResponse();
        return sob;
    }

    private static SoapSerializationEnvelope getEnvelope(String namespace, String method, String
            soapAction, String transUrl,
                                                         LinkedHashMap<String, Object> properties, int
                                                                 envolopeVersion, int
                                                                 timeout) throws IOException,
            XmlPullParserException {
    ...
    public static SoapObject getSoapObjectData(String namespace, String method, String soapAction, String
            transUrl,
                                               LinkedHashMap<String, Object> properties, int
                                                       envolopeVersion, int timeout)
            throws IOException, XmlPullParserException {
        SoapSerializationEnvelope envelope = getEnvelope(namespace, method, soapAction, transUrl,
                properties, envolopeVersion,
                timeout);
    ...
    public static SoapPrimitive getSoapPrimitiveData(String namespace, String method, String soapAction,
                                                     String transUrl,
                                                     LinkedHashMap<String, Object> properties, int
                                                             envolopeVersion, int
                                                             timeout) throws IOException,
    ...
    public static SoapPrimitive getSoapPrimitiveResponse2(SoapObject request, int
            envolopeVesion, String serviceName, int timeout) throws IOException,
            XmlPullParserException {

        SoapSerializationEnvelope envelope = getEnvelope(request, envolopeVesion,
                serviceName, timeout);
        SoapPrimitive sob = (SoapPrimitive) envelope.getResponse();
        return sob;
    }

    public static SoapPrimitive getPrimitiveResult(LinkedHashMap<String, Object> properties, String method,
