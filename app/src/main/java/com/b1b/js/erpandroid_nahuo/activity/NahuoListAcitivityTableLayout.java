...
public class NahuoListAcitivityTableLayout extends AppCompatActivity implements NoLeakHandler.NoLeakCallback {

    private NahuoAdapter2 nhAdapter;
    private List<NahuoInfoN> mLists;
    ProgressDialog pd;
    public boolean showCheckBox = false;
    private Context mContext = NahuoListAcitivityTableLayout.this;
